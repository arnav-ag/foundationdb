...
BlobKnobs::BlobKnobs() {
	...
	gcs_upload_progress_timeout = CLIENT_KNOBS->BLOBSTORE_GCS_UPLOAD_PROGRESS_TIMEOUT;
	gcs_upload_progress_check_interval = CLIENT_KNOBS->BLOBSTORE_GCS_UPLOAD_PROGRESS_CHECK_INTERVAL;
}
...
#define TRY_PARAM(n, sn)                                                                                               \
	...
	TRY_PARAM(gcs_upload_progress_timeout, gupt);
	TRY_PARAM(gcs_upload_progress_check_interval, gupci);
#undef TRY_PARAM
	return false;
}
...
#define _CHECK_PARAM(n, sn)                                                                                            \
	...
	_CHECK_PARAM(gcs_upload_progress_timeout, gupt);
	_CHECK_PARAM(gcs_upload_progress_check_interval, gupci);
#undef _CHECK_PARAM
	return r;
}
